...
const ROUTES_TO_WARM: string[] = [
  ...
  "/migrate-account",
  // FAQ tree
  "/recursos/como-usar-o-portal/sobre-dados-abertos",
  "/faqs/api-docs",
  "/faqs/api-tutorial",
  "/faqs/publish",
  "/faqs/reuse",
  ...
  "/admin/org/datasets",
  "/admin/org/reuses",
  "/admin/org/discussions",
  "/admin/org/members",
  "/admin/org/profile",
  "/admin/org/statistics",
  "/admin/system/datasets",
  "/admin/system/users",
  "/admin/system/topics",
  "/admin/system/posts",
  "/admin/system/editorial",
  "/admin/harvesters",
  "/admin/organizations",
  "/admin/statistics",
];
...
async function bootDisposableStack(): Promise<void> {
  ...
  if (await isPortServing("http://127.0.0.1:3001/")) {
    ...
    // First-compile of /login can take 60-90s on a cold cache.
