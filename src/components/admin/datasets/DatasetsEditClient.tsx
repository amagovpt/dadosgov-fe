                    ...
                    items={[
                      {
                        ...
                        content: (
                          <>
                            <p>
                              O título do seu conjunto de dados deve ser o mais preciso e específico
                              possível.
                            </p>
                            <p>
                              Deve também corresponder ao vocabulário utilizado pelos utilizadores
                              que, na maioria das vezes, procuram dados através do motor de
                              pesquisa.
                            </p>
                          </>
                        ),
                      ...
                      },
                      {
                        ...
                        content:
                          "Tem a opção de adicionar uma sigla ao seu conjunto de dados. Não é necessário que as letras que compõem essa sigla estejam separadas por pontos.",
                      },
                      {
                        ...
                        content: (
                          <>
                            <p>
                              A descrição do seu conjunto de dados permite que os utilizadores
                              obtenham informações sobre o conteúdo e a estrutura dos recursos
                              publicados.
                            </p>
                      ...
                      },
                      {
                        ...
                        content:
                          "A descrição resumida apresenta o seu conjunto de dados, em uma ou duas frases ajudando os utilizadores a entenderem rapidamente o conteúdo e melhora a sua visibilidade nos resultados de pesquisa.",
                      },
                      {
                      ...
                      },
                      {
                        ...
                        content:
                          "A frequência de atualização refere-se à frequência com que planeia atualizar os dados publicados. Essa frequência de atualização é apenas indicativa.",
                      },
                      {
